...
// Ejemplo de importación (ajusta la ruta según corresponda):
// import type { VueloFinal } from '../../componentes/TiposVuelo';

// O define un tipo temporal si no tienes el tipo aún:
type VueloFinal = any;
